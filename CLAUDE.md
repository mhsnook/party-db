...
importing it from `../../src`. CI typechecks all four (the `examples` job); v0.0.2 shipped a
broken `example-react-polyglot` because it did not. Two rules when you touch them: run BOTH
